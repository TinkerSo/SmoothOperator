...
GYRO_XOUT_H = 0x33
WHO_AM_I_REG = 0x00
WHO_AM_I_DEFAULT_VAL = 0xEA

bus = smbus2.SMBus(1)

def write_register(addr, value):
    bus.write_byte_data(ICM20948_I2C_ADDR, addr, value)

def setup_icm20948():
    who_am_i = bus.read_byte_data(ICM20948_I2C_ADDR, WHO_AM_I_REG)
    print(f"ICM-20948 Device ID: 0x{who_am_i:02X}")
    if who_am_i != WHO_AM_I_DEFAULT_VAL:
        print("ICM-20948 not found. Please check your connections.")
        return False
